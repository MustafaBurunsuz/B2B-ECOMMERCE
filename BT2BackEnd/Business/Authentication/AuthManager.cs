...
namespace Business.Authentication
{
    public class AuthManager : IAuthService
    {
        ...
        public async Task<IDataResult<CustomerToken>> CustomerLogin(CustomerLoginDto customerLogin)
        {
            var customer = await _customerService.GetByEmail(customerLogin.Email);
            if (customer == null)
            ...
            var result = HashingHelper.VerifyPasswordHash(customerLogin.Password, customer.PasswordHash, customer.PasswordSalt);
