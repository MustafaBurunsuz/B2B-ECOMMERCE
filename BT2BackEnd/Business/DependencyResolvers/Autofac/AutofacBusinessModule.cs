...
namespace Business.DependencyResolvers.Autofac
{
    public class AutofacBusinessModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CustomerRelotionshipManager>().As<ICustomerRelotionshipService>().SingleInstance();
            builder.RegisterType<EfCustomerRelotionshipDal>().As<ICustomerRelotionshipDal>().SingleInstance();
